...
public class AsignacionValidacionDTO implements Serializable {
    ...
    public AsignacionValidacionDTO() {
    }

    public AsignacionValidacionDTO(Long idAsignValidador) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AsignacionValidacionDTO)) {
            return false;
        }
        AsignacionValidacionDTO other = (AsignacionValidacionDTO) object;
    ...
    public String toString() {
        return "dtos.AsignacionValidacionDTO[ idAsignValidador=" + idAsignValidador + " ]";
    }
