...
public class RutinasTiempoImpl {
	...
	/*	*//**
			 ...
			 * @return List<Integer>
			 *//*
				 * public List<ComboValuesVO> obtenerAnioactualAniosAnterires(Date fecha,
				 * Integer numeroAnos){ List<ComboValuesVO> listaComboValuesVO = new
				 * ArrayList<ComboValuesVO>(); ComboValuesVO comboValuesVO = new
				 * ComboValuesVO(); Calendar calendar = Calendar.getInstance();
				 ...
				 * 
				 * for (int i = 1; i <= numeroAnos; i++) { calendar.add(Calendar.YEAR, -i);
	...
	public Date getFechaActualFormat(String formato) {
        Date fechaActual = new Date();
	...
	/*
	 * Devuelve la fecha en formato yyyy-mm-dd y tipo String
	 * */
	public static String getFecha_YYYYMMDD(Date date){
	...
	/**
	 * Método que recibe una fecha tipo Date y 
	 * retorna el nombre del dia correspondiente
	 ...
	 * si se coloca el pais EUA, regresara el numero de dia Domingo=1,Lunes=2...
	 */
	...
	/**
	 * Evalua 2 horas y determina si la hora1 es mayor a la hora2
	 * @author Javier Flores
	 * @param hora1
	 * @param hora2
	 * @return boolean
	 */
	public boolean comparaHoras(String hora1,String hora2){
		
		boolean respuesta= false;
		SimpleDateFormat format = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");			
		String date1 = "01/01/2000 " + hora1;
		String date2 ="01/01/2000 "  + hora2;
	...
	public String sumarRestarHorasFechaString(String fecha, int horas,String formato){
		...
		try {
			...
			calendar.add(Calendar.HOUR, horas);
			fechaString=format.format(calendar.getTime());
		} catch (Exception e) {
