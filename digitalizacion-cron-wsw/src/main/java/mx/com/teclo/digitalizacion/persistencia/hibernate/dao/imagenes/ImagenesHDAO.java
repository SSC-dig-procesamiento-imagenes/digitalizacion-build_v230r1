...
public interface ImagenesHDAO extends BaseDao<ImagenesDTO>{
	 ...
	 * @throws Exception 
	 */
	void marcarImagenDTOComoRechazada(ImagenesDTO imagen) throws Exception;
	 ...
	 */
	List<ImagenesDTO> getTodasLasImagenesDTONoAsignadas();
...
//	void marcarImagenesDTODependientes(ImagenesDTO imagen1, ImagenesDTO imagen2);
	...
	List<ImagenesDTO> liberarImagenesPorLote(LotesDTO lote);
	
	List<ImagenesDTO> getImagenesListasParaLiberarPorLoteId(Long idLote);
}
