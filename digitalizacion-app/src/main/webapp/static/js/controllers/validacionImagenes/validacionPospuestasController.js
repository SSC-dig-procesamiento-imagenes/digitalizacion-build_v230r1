angular.module(appTeclo).controller(
		"validacionPospuestasController",function($rootScope, $scope, $location, $window, $timeout,
				validacionPospuestasService,growl, showAlert, $routeParams) {
            "use strict";
        ...
        let buscaImagenSeleccionadaEnLista = function(value, index, array) {
            ...
            let buscarTodasMarcasVehiculos = function () {
                validacionPospuestasService.getTodasMarcasVehiculos()
            ...
            let procederProcesoInicial2 = function () {
                validacionPospuestasService.tieneAsignacionesPospuestas()
                    .success(function (data) {
                        $scope.tieneAsignaciones = data;
                        if($scope.tieneAsignaciones === false){
                            showAlert.aviso("Usted no tiene boletas pospuestas.",testAviso);
			...
			$scope.clickEnTablaImagenes = function(imagenVO){
				...
				if($scope.imagenRealSeleccionada.lbImagenAnverso !== null){//Ya tiene blob asignado
                    ...
                    validacionPospuestasService.blobsByIdImagen(idImagenSeleccionada)
                        .success(function (data) {
			...
			$scope.isImagenAceptable = function (imagen) {
                validacionPospuestasService.isImagenAceptable(imagen)
                    .success(function (data) {
                        return data;
                    }).error(function (data) {
                        if (data.message) {
            ...
            let procederAceptarImagen = function () {
                ...
                validacionPospuestasService.marcarImagenAceptada($scope.imagenRealSeleccionada)
                    .success(function (data) {
                            //$scope.enterDentro = true;
			...
			$scope.clickEnBotonAceptarImagen = function(){
				...
				if($scope.imagenRealSeleccionada ){
                    ...
                    validacionPospuestasService.isImagenAceptable($scope.imagenRealSeleccionada)
                        .success(function (data) {
                            if(data){
                                $scope.validaFraccion = false;
        ...
        $scope.procederRechazarImagen = function () {
                validacionPospuestasService.marcarImagenRechazada($scope.cancelarImagenVO)
                    .success(function (data) {
            ...
            let procederCambiarOrdenImagenes = function () {
                ...
                validacionPospuestasService.cambiaOrdenImagenes(idLbImagenSeleccionada)
                    .success(function (data) {
                        $scope.imagenRealSeleccionada.lbImagenAnverso = data[0];
                        $scope.imagenRealSeleccionada.lbImagenReverso = data[1];
