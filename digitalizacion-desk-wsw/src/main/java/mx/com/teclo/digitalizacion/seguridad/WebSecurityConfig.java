package mx.com.teclo.digitalizacion.seguridad;
...
import mx.com.teclo.arquitectura.ortogonales.seguridad.filtro.AuthenticationTokenFilterWs;
...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.antMatchers("/autorizacion/**").permitAll()
