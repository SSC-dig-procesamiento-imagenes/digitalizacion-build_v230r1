...
public class LotesDTO implements Serializable {

	private static final long serialVersionUID = -4368326130778071479L;

	@Id
	@SequenceGenerator(name = "sTDP004", sequenceName="SQDP_REG_TDP004", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sTDP004")
